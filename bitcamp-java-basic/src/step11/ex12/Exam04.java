...
public class Exam04 {
    public static void main(String[] args) {
        ...
        // 비록 m1과 m2는 같은 값을 가지고 있지만 인스턴스가 다르다.
        ...
        // 비록 m1과 m2는 같은 문자열을 갖고 있지만 인스턴스가 다르다.
        ...
        // String클래스는 Object로부터 상속 받은 toString()을 오버라이딩 했다.
        // => 스트링 인스턴스에 보관된 문자열을 리턴하도록 만들었다.
        System.out.printf("%s, %s\n", s2.toString(), s2.toString());
        
        // String클래스는 Object로부터 상속 받은 equals()를 오버라이딩 했다.
