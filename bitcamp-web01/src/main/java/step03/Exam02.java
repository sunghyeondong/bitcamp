...
public class Exam02 extends GenericServlet {
    ...
    public void service(ServletRequest request, ServletResponse response) throws ServletException, IOException {
        ...
        // 출력할 콘텐츠의 타입(MIME type)이 무엇이고, 어떤 문자코드표(character-set)를 사용하여 변환할 것인지 지정한다.
        response.setContentType("text/plain; charset=UTF-8");
        
        // 출력스트림을 꺼낼 때 스트림에서 사용할 문자표를 지정하지 않으면 기본으로 ISO-8859-1 문자표를 사용하여 문자열을 출력한다.
        ...
        // 해결책?
        // => ServletResponse 객체에서 출력 스트림을 꺼내기 전에
...
// => 그러나 지금은 메일 뿐만 아니라 다방면에서 컨텐츠의 타입을 지정하는 용도로 사용하고 있다.
// => 예) text/html, text/plain, application/octet-stream
