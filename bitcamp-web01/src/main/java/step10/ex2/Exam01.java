...
public class Exam01 extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 유효기간을 설정하면 웹 브라우저를 닫아도, 컴퓨터를 종료해도 유지된다.
        ...
        // 웹 브라우저를 닫으면 유효기간이 설정되지 않은 쿠키는 자동으로 삭제된다.
        ...
        // HTTP/1.1 200
        // Set-Cookie: c1=aaa; Max-Age=10; Expires=Wed, 23-May-2018 01:53:50 GMT
        // Set-Cookie: c2=bbb; Max-Age=30; Expires=Wed, 23-May-2018 01:54:10 GMT
        // Set-Cookie: c3=ccc
        // Content-Type: text/plain;charset=UTF-8
        // Content-Length: 28
        // Date: Wed, 23 May 2018 01:53:40 GMT
        // (빈 줄)
        // 내용...
    }
}
